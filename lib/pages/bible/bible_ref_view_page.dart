...
class BibleRefViewPage extends StatelessWidget {
  ...
  BibleRefViewPage({super.key, required this.bibleRef}) {}
...
//..loadRequest(Uri.parse(url));
  ...
  Widget build(BuildContext context) {
    ...
    if (bibleRefSplited.length > 2) {
      final bibleBookRef = "https://www.christianity.com/bible/niv/${bibleRefSplited[0]}-${bibleRefSplited[1]}/";
      final bookChapterParaRef = bibleRefSplited[2].replaceAll(":", "-");
      bibleRefURL = bibleBookRef.trim() + bookChapterParaRef.trim();
    } else {
      final bibleBookRef = "https://www.christianity.com/bible/niv/${bibleRefSplited[0]}/";
    ...
    return Scaffold(
        appBar: AppBar(
            title: const Text("Bible Reference"),
            centerTitle: true,
            backgroundColor: Color.fromARGB(255, 210, 67, 82)),
        body: WebViewWidget(
